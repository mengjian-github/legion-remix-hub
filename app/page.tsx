...
export default function Home() {
  ...
  const collectionSchema = {
    ...
    mainEntity: {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Class Mounts Guide', url: 'https://legionremixhub.com/guides/class-mounts' },
        { '@type': 'ListItem', position: 3, name: 'Discipline Priest Guide', url: 'https://legionremixhub.com/classes/priest/discipline' },
        { '@type': 'ListItem', position: 4, name: 'Marksmanship Hunter Guide', url: 'https://legionremixhub.com/classes/hunter/marksmanship' },
        { '@type': 'ListItem', position: 5, name: 'Guardian Druid Guide', url: 'https://legionremixhub.com/classes/druid/guardian' },
      ],
    },
  };
  ...
  const quickTasks = [
    ...
    {
      title: 'Class mounts',
      detail: 'Answer-first table for every Felscorned and legacy class mount.',
  ...
  const mainGuideDirectory = [
    { label: 'Infinite Knowledge farming', href: '/guides/infinite-knowledge' },
    { label: 'Strange Humming Crystal routes', href: '/guides/bronze-farming#strange-humming-crystal' },
    { label: 'Havoc Demon Hunter builds', href: '/classes/demon-hunter/havoc' },
    { label: 'Brewmaster Monk hard mode', href: '/classes/monk/brewmaster' },
    { label: 'Subtlety Rogue rotations', href: '/classes/rogue/subtlety' },
    { label: 'Protection Paladin tanks', href: '/classes/paladin/protection' },
    ...
    { label: 'Zygor addon alternatives', href: '/guides/leveling#fastest-way-to-level-legion-remix' },
    { label: 'fastest leveling paths', href: '/guides/leveling#fastest-way-to-level-legion-remix' },
    { label: 'Legion Remix lag fixes', href: '#legion-remix-lag' },
    { label: 'Time Crisis objectives', href: '/guides/getting-started#legion-remix-hard-mode' },
    { label: 'To Fel and Back achievement', href: '/guides/getting-started#legion-remix-hard-mode' },
    { label: 'Legion Remix rare elites', href: '/guides/bronze-farming#rare-elites-legion-remix' },
    { label: 'Legion Remix hard mode setup', href: '/guides/getting-started#legion-remix-hard-mode' },
    { label: 'Infinite Power upgrades', href: '/guides/infinite-knowledge#phase-1' },
    { label: 'Legion Remix calculator usage', href: '/calculator' },
    { label: 'Legion Remix a character with that name already exists error', href: '/faq#troubleshooting-and-performance' },
    { label: 'Legion Remix druid flight form unlock', href: '/classes/druid' },
    { label: 'Legion Remix DH build comparisons', href: '/classes/demon-hunter' },
    { label: 'Legion Remix world quest unlocks', href: '/guides/getting-started#how-to-unlock-world-quests-legion-remix' },
    { label: 'Legion Remix lag troubleshooting on laptops', href: '#legion-remix-lag' },
    { label: 'Legion Remix Violet Spellwing planning', href: '/guides/bronze-farming#achievement-targets-legion-remix' },
    { label: 'Legion Remix Bronze per hour benchmarks', href: '/guides/bronze-farming#time-investment-calculator' },
    { label: 'Legion Remix Infinite Bazaar vendors', href: '/rewards' },
    { label: 'Broken Isles reputation routes', href: '/reputation' },
    { label: 'Legion Remix Artifact path swaps', href: '/guides/infinite-knowledge' },
    { label: 'Legion Remix Mythic+ Turbo Boost weeks', href: '/guides/leveling#fastest-way-to-level-legion-remix' },
    { label: 'Legion Remix Argus Eternal roadmap', href: '#phase-roadmap' },
    { label: 'Legion Remix housing decor unlocks', href: '/rewards' },
    { label: 'Legion Remix campaign boost prep', href: '/guides/leveling#fastest-way-to-level-legion-remix' },
    { label: 'Legion Remix console achievements', href: '/guides/getting-started#legion-remix-hard-mode' },
    { label: 'Legion Remix Bronze cache farming', href: '/guides/bronze-farming#bronze-collection-in-action' },
